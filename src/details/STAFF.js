...
export default class STAFF {
    ...
    constructor(){
		...
		this.filtType = 0;//0-all 1-经理 2-主管 3-员工 4-实习
		this.word = '';//搜索关键字
	...
	_filtStaff(filtType){
	    ...
	    switch(parseInt(filtType)){
			...
			case 2:
			    this.staff = this.allStaff.filter(item => {
				    return item.info.id == '主管';
				});
				break;
			case 3:
			    this.staff = this.allStaff.filter(item => {
				    return item.info.id == '员工';
				});
				break;
			case 4:
			    this.staff = this.allStaff.filter(item => {
		    ...
		    case 0: //身份
			    ...
			    this.allStaff.forEach(item => {
				    switch(item.info.id) {
					  ...
					  case 2:
					      item.info.id = '主管'; break;
					  case 3:
					      item.info.id = '员工'; break;
					  case 4:
...
//模拟数据库
STAFF.rawData = [{ descrip:'我只是一个孩子', sex: '男', age: 40, name: '张三', id: '经理'},
                 { descrip:'我只是一个孩子', sex: '女', age: 31, name: '赵静', id: '主管'},
				         { descrip:'我只是一个孩子', sex: '女', age: 27, name: '王二麻', id: '员工'},
                 { descrip:'我只是一个孩子', sex: '女', age: 25, name: '李晓婷', id: '员工'},
                 { descrip:'我只是一个孩子', sex: '男', age: 23, name: '张春田', id: '实习'},
                 { descrip:'我只是一个孩子', sex: '男', age: 25, name: '刘建国', id: '员工'},
                 { descrip:'我只是一个孩子', sex: '男', age: 24, name: '张八', id: '员工'},
                 { descrip:'我只是一个孩子', sex: '男', age: 35, name: '李四', id: '主管'},
                 { descrip:'我只是一个孩子', sex: '男', age: 29, name: '王五', id: '员工'},
                 { descrip:'我只是一个孩子', sex: '男', age: 28, name: '赵六', id: '员工'},
                 { descrip:'我只是一个孩子', sex: '男', age: 20, name: '孙七', id: '实习'}];
